<template>
    <div class="modal fade modalbox" id="AboutModal"  data-bs-backdrop="true" tabindex="-1" style="display: none;"
         aria-hidden="true">
                ...
                <div class="modal-body">
                    ...
                    >
                        <p>
                            ...
                            <span style="font-weight: 900;">Travel</span> <span
                            style="color: rgb(240, 139, 35); font-weight: 900;">Club</span>
                            – это в первую очередь команда людей, которые не представляют свою жизнь без
                            путешествий и готовы делиться своим опытом.
                    ...
                    <div class="d-flex justify-content-center">
                        <a  data-bs-toggle="modal" aria-label="Комментарии и отзывы"
                           data-bs-target="#CommentsModal" class="btn btn-orange rounded">
                            Оставить отзыв
                        </a>
                    </div>
                </div>
