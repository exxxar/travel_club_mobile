                    ...
                    <div class="row mt-2">
                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                <label for="heading-image">Обложка новости</label>
                                <input type="file" class="form-control-file" id="heading-image"/>
                            </div>
            ...
            <div class="col-md-4">
                ...
                <ul class="list-group simple-list-group">
                    <li class="list-group-item" :key="article.id" v-for="article in filteredArticles">
                        ...
                        <p v-if="article.publish_at"><small>Дата публикации: <strong>{{
                                new
