<template>
    <ValidationObserver v-slot="{ invalid }">
        <b-modal id="newUserTourModalBox" title="Новый тур клиента" centered scrollable size="lg">
            ...
            <template #modal-footer>
                <div class="row w-100 m-auto">
                    <div class="col-6 col-md-6 contact-btn text-center">
                        <button class="btn btn-travel" style="width: 100%" @click="$bvModal.hide('newUserTourModalBox')">
                            Отмена
                        </button>
                    </div>
                    <div class="col-6 col-md-6 contact-btn text-center">
            ...
            saveClientTour(){
                ...
                this.$store.dispatch('newClientTour', formData)
                    .then(response => {
                        ...
                        this.loading = false;
                        this.$bvModal.hide('newUserTourModalBox')
