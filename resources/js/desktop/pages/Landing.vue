    ...
    <LandingLayout>
        <section id="home" style="height: 100vh; width: 100%;" class="ms-auto me-auto parallax">
            <div class="container mt-auto mb-auto" style="height: 100%;">
                ...
                <div class="tc-row m-auto mobile tablet d-lg-none" style="height: 100%; width: 100%;">
                    <div class="col-md-6 col-lg-4 col-sm-10 mt-3 m-auto">
            ...
            <svg class="editorial"
                ...
                <g class="parallax">
                    ...
                    <use xlink:href="#gentle-wave" x="48" y="3" fill="#f8e30159"/>
                    <use xlink:href="#gentle-wave" x="48" y="6" fill="rgb(255, 224, 134)"/>
                </g>
            </svg>
            <div class="particles">
        ...
        <section id="welcome" class="mb-5">
            <div class="container m-auto" style="height: 100%;">
                <div class="tc-row m-auto" style="height: 100%; width: 100%; ">
                    <div class="col-md-6 m-auto d-none d-md-none d-lg-block position-relative">
                        <div class="text-center">
                            <img src="/images/LOGO-1.png" class="logo-1-1"
                                 style="width: 100%;height: 100%;max-width: 300px;"/>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-sm-12 m-auto">

                        <div class="two" style="position: relative;width: 80%;margin: auto;">
                            <h1 style="">О нас
                                <span>Travel<span
                                    style="color: rgb(240, 139, 35);display: inline;padding: 0;">Club</span>
                                            </span>
                            </h1>
                        </div>
                        <div class="mx-auto mt-4 mb-3 justify-content-center flex-wrap"
                             style="color: #062348; font-size: 14px; font-weight: 700; width: 80%; text-align: justify">

                            <p>
                                Сеть туристических агентств
                                <span style="font-weight:900;">Travel<span
                                    style="color: #f08b23; font-weight:900;">Club</span></span>
                            ...
                            <div class="d-flex justify-content-center landing-employees">
<!--                                <div class="col-12">-->
                                    <employee-list :visible_title="false" class="w-100"/>
<!--                                </div>-->
                            </div>
                        </div>
        ...
        <section id="why" class="my-5">
            <div class="container m-auto" style="height: 100%;">
                <div class="tc-row m-auto" style="height: 100%; width: 100%;">
                    ...
                    <div class="col-md-6 d-none d-md-none d-lg-block position-relative">
                        <div class="text-center">
        ...
        <section id="travel" class="my-5" style="height:500px;">
            <div class="container m-auto" style="height: 100%;">
                <div class="tc-row m-auto tablet desktop" style="height: 100%; width: 100%;">
                    <div class="col-md-6 desktop">
                        <div class="travel-card-illustration">
                            <!--                            <img src="/images/travel-illustration.png" class="travel-illustration"/>-->
                            <base-icon name="TravelImage" height="100%" width="100%"></base-icon>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-sm-12 tablet-travel-card-col m-auto">
                        <div class="ms-0 me-auto travel-card">
                            <div class="travel-mark trip-mark">
                                <img src="/images/trip-mark.svg"/>
                            </div>
                            ...
                            <a href="/tours" class="travel-card-more tc-row align-items-center justify-content-end">
                                <h5 class="more-text my-auto ms-auto me-0" style="cursor:pointer">
                                    начать прямо сейчас</h5>
                                <div class="more-button" style="cursor:pointer">
                                    <div>
                                        <base-icon name="ChevronRight" width="25" height="25"></base-icon>
                                    </div>
                                </div>
                            </a>
<!--                            <img src="/images/blue-inc-d.svg" class="blue-inc" style="position: absolute;"/>-->
<!--                            <img src="/images/orange-inc-d.svg" class="orange-inc" style="position: absolute;"/>-->
                        </div>
                    </div>
                </div>
                <div class="tc-row m-auto mobile d-sm-none" style="height: 100%; width: 100%;">
                    <div class="card card-profile">
                        ...
                        <div class="card-body tc-row m-auto" style="height:100%; width:100%">
                            <div
                                class="tc-row align-items-center justify-content-center mx-auto mb-3 travel-card-title-row"
                                style="height:100px;width:100%;">
                                <div class="col-md-8 p-0">
                                    <div class="tc-row me-auto ms-0 my-auto travel-card-title"
                                ...
                                <div class="col-md-8 p-0">
                                    <div class="tc-row ms-auto me-0 my-auto travel-card-title"
                                         style="position:relative;height:50px;width:250px;">
                                        <h1 class="title-2">c <span>TravelClub</span></h1>
                                        <img src="/images/orange-brush.svg" class="orange-brush"
                                             style="position: absolute;"/>
                            ...
                            <!--                            <div class="travel-card-features">-->
                            <!--                                <div class="row align-items-center justify-content-center m-auto" style="width:100%; height: 100%;">-->
                            <!--                                <div class="col-6">-->
                            <!--                                    <div class="feature">-->
                            <!--                                        <h4 class="feature-1"><strong>лучшие</strong></h4>-->
                            <!--                                        <h2 class="feature-2">туры</h2>-->
                            <!--                                    </div>-->
                            <!--                                    </div>-->
                            <!--                                     <div class="col-6">-->
                            <!--                                    <div class="feature">-->
                            <!--                                        <h4 class="feature-1"><strong>лучшие</strong></h4>-->
                            <!--                                        <h2 class="feature-2">цены</h2>-->
                            <!--                                    </div>-->
                            <!--                                    </div>-->
                            <!--                                </div>-->
                            <!--                            </div>-->
                            ...
                            <a href="/tours" class="tc-row align-items-center justify-content-end m-auto" style="width:100%;">
                                <h5 class="more-text my-auto ms-auto me-0" style="cursor:pointer">
                                    начать прямо сейчас</h5>
                                <div class="more-button" style="cursor:pointer">
                                    <div>
...
<!--                        <img src="/images/blue-inc.svg" class="blue-inc" style="position: absolute;"/>-->
<!--                        <img src="/images/orange-inc.svg" class="orange-inc" style="position: absolute; top: 80px;"/>-->
                    </div>
                </div>
            </div>
        </section>
        <section id="avia" class="my-5" style="height:500px;">
            <div class="container m-auto" style="height: 100%;">
                <div class="tc-row m-auto desktop tablet" style="height: 100%; width: 100%;">
                    <div class="col-12 col-md-6 col-sm-12 tablet-travel-card-col m-auto">
                        <div class="me-0 ms-auto travel-card-orange">
                            <div class="travel-mark avia-mark">
                                <img src="/images/avia-mark-d.svg"/>
                            </div>
                            <div class="travel-card-title">
                            ...
                            <div class="travel-card-description">
                                <p>В данном разделе Вы сможете приобрести авиабилет в любую точку.</p>
                                <p>Возможна оплата онлайн или сделать заказ с сайта.</p>
                            </div>
                            <a href="/hot-tours" class="travel-card-more tc-row align-items-center justify-content-end">
                                <h5 class="more-text mt-auto mb-auto" style="cursor:pointer">
                                    начать прямо сейчас</h5>
                                <div class="more-button" style="cursor:pointer">
                                    <div>
                                        <base-icon name="ChevronRight" width="25" height="25"></base-icon>
...
<!--                            <img src="/images/avia-blue-inc-d.svg" class="blue-inc" style="position: absolute;"/>-->
<!--                            <img src="/images/avia-orange-inc-d.svg" class="orange-inc" style="position: absolute;"/>-->
                        </div>
                    </div>
                    <div class="col-md-6 d-none d-md-none d-lg-block">
                        <div class="travel-card-illustration">
                            <base-icon name="AviaImage" height="100%" width="100%"></base-icon>
                            <!--                            <img src="/images/travel-illustration-2.png" class="illustration"/>-->
                        </div>
                    </div>
                </div>
                <div class="tc-row m-auto mobile d-sm-none" style="height: 100%; width: 100%;">
                    <div class="card card-profile">
                        ...
                        <div class="card-body row m-auto" style="height:100%; width:100%">
                            <div
                                class="row align-items-center justify-content-center mx-auto mb-3 travel-card-title-row"
                                style="height:100px;width:100%;">
                                <div class="col-md-8 p-0">
                                    <div class="row me-auto ms-0 my-auto travel-card-title"
                                         style="position:relative;height:50px;width:250px;">
                                        <h1 class="title-1"><span>Л</span>етай</h1>
                                        <img src="/images/blue-brush.svg" class="blue-brush"
                                             style="position: absolute;"/>
                                ...
                                <div class="col-md-8 p-0">
                                    <div class="row ms-auto me-0 my-auto travel-card-title"
                                         style="position:relative;height:50px;width:250px;">
                                        <h1 class="title-2">c <span>TravelClub</span></h1>
                                        <img src="/images/orange-brush.svg" class="orange-brush"
                                             style="position: absolute;"/>
                            ...
                            <a href="/hot-tours" class="tc-row align-items-center justify-content-end m-auto" style="width:100%;">
                                <h5 class="more-text my-auto ms-auto me-0" style="cursor:pointer">
                                    начать прямо сейчас</h5>
                                <div class="more-button" style="cursor:pointer">
                                    <div>
...
<!--                        <img src="/images/orange-inc.svg" class="orange-inc" style="position: absolute; top: 80px;"/>-->
        ...
        <section id="russia" class="my-5" style="height:500px;">
            <div class="container m-auto" style="height: 100%;">
                <div class="tc-row m-auto desktop tablet" style="height: 100%; width: 100%;">
                    <div class="col-md-6 desktop">
                        <div class="travel-card-illustration">
                            <base-icon name="RussiaImage" width="100%" height="100%"></base-icon>
                            <!--                            <img class="illustration" src="/images/section3.png"/>-->
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-sm-12 tablet-travel-card-col m-auto">
                        <div class="ms-0 me-auto travel-card">
                            <div class="travel-mark hotel-mark">
                                <img class="img" src="/images/russia-mark.png" style="width: 150px; height: 150px">
                            </div>
                            <div class="travel-card-title">
                                <h1 class="title-1"><span>Т</span>уры</h1>
                                <img src="/images/blue-brush.svg" class="blue-brush"
                                     style="position: absolute;top:10px"/>
                                <h1 class="title-2">по <span>России</span></h1>
                                <img src="/images/orange-brush.svg" class="orange-brush"
                                     style="position: absolute;top:57px"/>
                            </div>
                            <div class="travel-card-description">
                                <p>Путешествуй с <span style="font-weight:900;">Travel<span
                                    style="color: #f08b23; font-weight:900;">Club</span></span>

                                    по всей России.</p>
                                <p>Возможна оплата онлайн или сделать заказ с сайта.</p>
                            </div>
                            <a href="/russia-tours" class="travel-card-more tc-row align-items-center justify-content-end">
                                <h5 class="more-text mt-auto mb-auto" style="cursor:pointer">
                                    начать прямо сейчас</h5>
                                <div class="more-button" style="cursor:pointer">
                                    <div>
                    ...
                    <div class="card card-profile">
                        ...
                        <div class="card-body tc-row m-auto" style="height:100%; width:100%">
                            ...
                            <div class="card-description my-3 mx-auto ">
                                <p>Путешествуй с
                                    <span style="font-weight:900;">Travel
                                            <span
                                                style="color: #f08b23;font-weight:900;">Club</span>
                                        </span> по всей России.
                                </p>
                                <p>Возможна оплата онлайн или сделать заказ с сайта.</p>
                            </div>
                            <a href="/russia-tours" class="tc-row align-items-center justify-content-end m-auto" style="width:100%;">
                                <h5 class="more-text my-auto ms-auto me-0" style="cursor:pointer">начать прямо сейчас</h5>
                                <div class="more-button" style="cursor:pointer">
                                    <div>
                                        <base-icon name="ChevronRight" width="25" height="25"></base-icon>
                                    </div>
...
<!--                                    &lt;!&ndash;                                <div class="row family-row family-description" style="width: 80%; color: #062348;font-size: 13px;font-weight: 900;">&ndash;&gt;-->
...
<!--                                                    </div>-->
<!--                                                </div>-->
<!--                                                <div class="col-12 col-md-12 col-sm-6 ps-0">-->
...
<!--                        </h1>-->
                        ...
                        <div class="buttonWrapper">
                            <!--    <a href="/m/" class="btn btn-orange me-4 d-flex justify-content-center align-items-center"
                                   target="_blank">
    ...
    -->
                            <a href="#qr" class="footer-btn d-flex" id="hero-qr-button" style="color: white !important;">
                                <base-icon name="QrCode" class="me-1 my-auto"></base-icon>
                                Попробуй с телефона
                            </a>
...
<!--                </div>-->
                ...
                <div class="tc-row">
                    <div class="col-12 col-sm-4">
                        <div class="imgWrapper">
                            <img src="/img/item/item4.jpg" alt="image" class="image">
                        </div>
                        <div class="three">
                            <h4 class="item-title"><span></span>Путешествуй c TravelClub</h4>
                            <div class="item-text">
                                Вы с легкостью сможете провести оплату онлайн или сделать заказ с сайта.
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-sm-4">
                        <div class="imgWrapper">
                            <img src="/img/item/item1.jpg" alt="image" class="image">
                        </div>
                        <div class="three">
                            <h4 class="item-title"><span></span>Туры по России</h4>
                            <div class="item-text">
                    ...
                    <div class="col-12 col-sm-4">
                        <div class="imgWrapper">
                            <img src="/img/item/item2.jpg" alt="image" class="image">
                        </div>
                        <div class="three">
                            <h4 class="item-title"><span></span>Мы - Travel Club Family</h4>
                            <div class="item-text">
                    ...
                    <div class="col-12 col-sm-4">
                        <div class="imgWrapper">
                            <img src="/img/item/item3.jpg" alt="image" class="image">
                        </div>
                        <div class="three">
                            <h4 class="item-title"><span></span>Летай вместе с нами</h4>
                            <div class="item-text">
                    ...
                    <div class="col-12 col-sm-4">
                        <div class="imgWrapper">
                            <img src="/img/item/item5.jpg" alt="image" class="image">
                        </div>
                        <div class="three">
                            <h4 class="item-title"><span></span>Отели любого уровня</h4>
                            <div class="item-text">
                    ...
                    <div class="col-12 col-sm-4">
                        <div class="imgWrapper">
                            <img src="/img/item/item6.jpg" alt="image" class="image">
                        </div>
                        <div class="three">
                            <h4 class="item-title"><span></span>Новый уровень путешествий</h4>
                            <div class="item-text">
            ...
            <div class="qrWidget" id="qr">
                ...
                <div class="qrCodeImg">
                    <img src="/img/qr.jpg" alt="qr" class="img">
                </div>
            </div>
            <!-- * qrWidget -->
        ...
        <div class="sidebar">
            <div class="toggleButton sidebarTrigger" @click="sidebarOpen()">
                <base-icon name="ArrowRight"></base-icon>
            </div>
            ...
            <div class="sidebarFooter">
                ...
                <a rel="noreferrer" href="https://www.instagram.com/travelclub_tours" target="_blank"
                   class="button" aria-label="мы в инстаграм">
                    <base-icon name="Instagram" width="32" height="32"></base-icon>
                </a>
                <a rel="noreferrer"
                   href="https://wa.me/79064167872"
                   target="_blank" class="button" aria-label="наш контакт в вотспап">
                    <base-icon name="WhatsApp" width="32" height="32"></base-icon>
                </a>
            ...
            <div class="sidebarProducts">
                <div class="tc-row">
                    ...
                    <!--                        <p>Ул. Артема 100Д-->
                    <!--                        </p>-->
                    <!--                        <p> 8-800-101-96-66 <span class="ms-2"><i class="fab fa-whatsapp"></i> <i class="fab fa-viber"></i></span></p>-->
                    <!--                        <p> 071-339-90-89 <span class="ms-2"><i class="fab fa-whatsapp"></i> <i-->
