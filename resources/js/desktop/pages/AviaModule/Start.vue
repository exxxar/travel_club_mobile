<template>
    <div class='cont m-auto'>
                ...
                <div class="row align-items-center justify-content-center mx-auto mb-3 travel-card-title-row" style="height:100px;width:100%;">
                    ...
                    <div class="col-md-7 p-0">
                        <div class="row ml-auto mr-0 my-auto travel-card-title" style="position:relative;height:50px;width:350px;">
                            <h1 class="title-2"><span>в модуль подбора авиабилетов </span></h1>
        ...
        <div class="row m-auto justify-content-center align-items-center px-5" style="width: 80%;">
            <p style="color: #0f213d; font-family: 'Open Sans'; font-weight: 900; font-style: italic">
...
<!--        <div class="row m-auto justify-content-center align-items-center px-5">-->
<!--            <b-button class="btn btn-travel" @click="next">Начать</b-button>-->
<!--        </div>-->
    </div>
</template>
