                            ...
                            <div class="card card-signin mb-5" style="margin-top: 70px">
                                <div class="card-body">
                                            ...
                                            <div class="row align-items-center justify-content-center mx-auto mb-3 travel-card-title-row" style="height:100px;width:100%;">
                                                <div class="col-md-10 p-0">
                                                    <div class="row mr-auto ml-0 my-auto travel-card-title" style="position:relative;height:50px;width:250px;">
                                                        <h1 class="title-1"><span> З</span>абыли</h1>
                                    ...
                                    <div class="form-signin">
                                        <p style="font-family: 'Open Sans';font-weight: 700; font-style: italic; text-align: center; color:#0d274b; font-size: 12px">Введите Ваш email. На него придёт письмо с ссылкой, перейдя по которой вы сможете поменять пароль </p>
                                        <ValidationObserver v-slot="{ invalid }">
                                            <form autocomplete="off" @submit.prevent="requestResetPassword" method="post">
                                                ...
                                                <button type="submit" class="btn btn-lg btn-travel btn-block text-uppercase mt-3" :disabled="invalid||loading">
