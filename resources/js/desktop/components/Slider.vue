<template>
    <div>
        <div ref="sideNav" class="bm-menu">
            <nav class="bm-item-list text-truncate">
                <slot></slot>
            </nav>
        ...
        methods: {
            openMenu() {
                ...
                if (!this.noOverlay) {
                    ...
                    document.getElementById('slider-overlay').classList.add('bm-overlay');
                }
                if (this.right) {
            ...
            closeMenu() {
                ...
                document.getElementById('slider-overlay').classList.remove('bm-overlay');
                ...
                handler(oldValue, newValue) {
                    if (oldValue) {
                        this.$nextTick(() => {
                            ...
                            document.querySelector('.cross-style').style.right='50px';
                        });
                    }
                    if (newValue) {
                        if (
