<template>
    <div class="tour-module">
        <div class="row w-100 justify-content-center mx-auto mt-4 mb-5">
...
<!--                                        </span>-->
<!--                                </template>-->
<!--                                &lt;!&ndash;                            <template slot="limit">&ndash;&gt;-->
<!--                                &lt;!&ndash;                                <span class="multiselect__single"> и ещё {{ chosen_meals.length-2 }}&ndash;&gt;-->
<!--                                &lt;!&ndash;                                </span>&ndash;&gt;-->
<!--                                &lt;!&ndash;                            </template>&ndash;&gt;-->
<!--                                &lt;!&ndash;                            <template slot="singleLabel" slot-scope="props">&ndash;&gt;-->
<!--                                &lt;!&ndash;                                <span class="option__desc">&ndash;&gt;-->
<!--                                &lt;!&ndash;                                    <span class="option__title">{{props.option.Name}}</span>&ndash;&gt;-->
<!--                                &lt;!&ndash;                                </span>&ndash;&gt;-->
<!--                                &lt;!&ndash;                            </template>&ndash;&gt;-->
<!--                                &lt;!&ndash;                            <template slot="option" slot-scope="props">&ndash;&gt;-->
<!--                                &lt;!&ndash;                                <div>&ndash;&gt;-->
<!--                                &lt;!&ndash;                                    <div class="option__desc">&ndash;&gt;-->
<!--                                &lt;!&ndash;                                        <span class="option__title">{{props.option.Name}}</span>&ndash;&gt;-->
<!--                                &lt;!&ndash;                                    </div>&ndash;&gt;-->
<!--                                &lt;!&ndash;                                    <div class="row align-items-center m-auto" style="width: 100%; height: 100%">&ndash;&gt;-->
<!--                                &lt;!&ndash;                                        <p class="" style="font-size: 12px; margin:0px;">{{props.option.desc}}</p>&ndash;&gt;-->
<!--                                &lt;!&ndash;                                    </div>&ndash;&gt;-->
<!--                                &lt;!&ndash;                                </div>&ndash;&gt;-->
<!--                                &lt;!&ndash;                            </template>&ndash;&gt;-->
<!--                            </multiselect>-->
...
<!--                                track-by="Name"-->
<!--                                :multiple="true" :close-on-select="false" :clear-on-select="false"-->
<!--                                :loading="isHotelStarsLoading"-->
<!--                                :disabled="isHotelStarsLoading"-->
<!--                                @input="chooseHotelStars"-->
<!--                                @remove="removeHotelStars"-->
<!--                            >-->
<!--                                &lt;!&ndash;                            <template slot="limit">&ndash;&gt;-->
<!--                                &lt;!&ndash;                                <span class="multiselect__single "> и ещё {{ chosen_hotel_stars.length-2 }}&ndash;&gt;-->
<!--                                &lt;!&ndash;                                </span>&ndash;&gt;-->
<!--                                &lt;!&ndash;                            </template>&ndash;&gt;-->
<!--                                <template slot="selection" slot-scope="{ values, search, isOpen }">-->
...
<!--                                &lt;!&ndash;                            <template slot="singleLabel" slot-scope="props">&ndash;&gt;-->
<!--                                &lt;!&ndash;                                <span class="option__desc">&ndash;&gt;-->
<!--                                &lt;!&ndash;                                    <span class="option__title values__hotel-rating" v-if="props.option.Name!='Любая'">{{props.option.Name}}</span>&ndash;&gt;-->
<!--                                &lt;!&ndash;                                    <span class="option__title" v-else>{{props.option.Name}}</span>&ndash;&gt;-->
<!--                                &lt;!&ndash;                                </span>&ndash;&gt;-->
<!--                                &lt;!&ndash;                            </template>&ndash;&gt;-->
<!--                                &lt;!&ndash;                            <template slot="tag" slot-scope="{ option, remove }">&ndash;&gt;-->

<!--                                &lt;!&ndash;                                <span class="multiselect__tag">&ndash;&gt;-->
<!--                                &lt;!&ndash;                                    <span class="option__title values__hotel-rating" v-if="option.Name!='Любая' && option.Name.length>1">{{option.Name}}</span>&ndash;&gt;-->
<!--                                &lt;!&ndash;                                <span class="option__title" v-else>{{option.Name}}</span>&ndash;&gt;-->
<!--                                &lt;!&ndash;                                    <i aria-hidden="true" tabindex="1" class="multiselect__tag-icon" @click="remove(option)"></i>&ndash;&gt;-->
<!--                                &lt;!&ndash;                                </span>&ndash;&gt;-->
<!--                                &lt;!&ndash;                            </template>&ndash;&gt;-->
<!--                                <template slot="option" slot-scope="props">-->
<!--                                    <div class="option__desc">-->
                    ...
                    <div class="col-6 pl-1 pr-0">
                        <div class="row align-items-center justify-content-center m-auto w-100 h-100">
                            ...
                            <div class="row qty align-items-center justify-content-center m-auto" style="width: 100%;">
                                ...
                                <button type="button" class="btn plus text-center"
                                        @click="incrementChildren()" :disabled="children===3">+
                                </button>
                            </div>
                        </div>
                    </div>
...
<!--                    <div class="row align-items-center justify-content-center mx-auto mt-4" style="width: 100%;height: 100%;">-->
<!--                        <div class="col-12">-->
...
<!--                </div>-->
<!--                <div class="col-md-6 col-sm-12 col-12">-->
<!--                    <div class="row align-items-center justify-content-center mx-auto mt-4 mb-5" style="width: 100%;height: 100%;">-->
<!--                        <div class="col-md-12">-->
<!--                            <div class="row align-items-center justify-content-center m-auto" style="width: 100%;height: 100%;">-->
<!--                                <h4 class="multiselect-title">Интервал дат вылета</h4>-->
<!--                                <VueHotelDatepicker-->
        ...
        mounted() {
            ...
            if(this.tourModule.resort_country)
            {
                ...
                if(this.tourModule.resorts.length>0 && this.tourModule.resorts[0].Name != 'Любой')
                {
                    ...
                    this.$store.dispatch('getHotels', {country_id:this.resort_country.Id, town_id:town_id, star_id:''});
                }
                else {
                    this.resorts = this.tourModule.resorts;
