<template>
    <div id="avia-module">
        <div class="m-auto row align-items-center justify-content-center">
            <div v-if="!aviaModule.is_multi_city" class="row mx-auto align-items-center justify-content-center mt-2" style="width: 100%;">
...
<script>
    ...
    export default {
        ...
        methods: {
            nextStep() {
                this.$store.dispatch('changeAviaSteps', {key:'step2', value:true});
