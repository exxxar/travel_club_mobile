<template>
    <template>
        <div class="start-form mt-1">
            <div class="section">
                <img class="form-image" src="/images/5.png" style="width: 100%; height: 40vh"/>
            </div>
            <div class="section">
                        ...
                        <div class="row align-items-center justify-content-center mx-auto mb-3 travel-card-title-row" style="height:100px;width:100%;">
                            <div class="col-md-7 p-0">
                                <div class="row mr-auto ml-0 my-auto travel-card-title" style="position:relative;height:50px;width:250px;">
                                    <h1 class="title-1"><span>П</span>одберите авиабилеты</h1>
            ...
            <div class="section">
                <div class="row m-auto justify-content-center align-items-center" style="width: 100%; height: 100%;">
                    <p style="color: #0f213d; font-family: 'Open Sans'; font-weight: 900">Надоело искать, подбирать авиабилеты и следить за их ценой самостоятельно? Мы предлагаем заполнить заявку на подбор авиабилетов и наши менеджеры сделают всё за Вас!</p>
                </div>
            </div>
